...
Tell me the current state of the project (or a specific feature). Use the
`project-docs` skill.

Steps:
1. Read `docs/STATE.md` — summarize stage, environments, the feature index, and
   what's next.
2. If I named a feature after the command, open `docs/features/<feature>.md` and
